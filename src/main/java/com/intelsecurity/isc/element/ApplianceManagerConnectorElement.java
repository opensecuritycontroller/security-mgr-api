...
public interface ApplianceManagerConnectorElement {
     ...
     *
     * @return String given by user for Connector name
     */
     ...
     *
     * @return String given by user for Connector IP
     */
     ...
     *
     * @return Manager Connector RESTful BASIC_AUTH username
     */
     ...
     *
     * @return Manager Connector RESTful BASIC_AUTH password (in the clear)
     */
     ...
     *
     * @return Manager Connector RESTful KEY (in the clear)
     */
     ...
     *
     * @return Unique String representing manager plugin name
     */
    public ManagerTypeElement getManagerType();

    /**
     * If Manager Notification method is PERSISTED_URL, returns the last known ISC notification ip address known by the
     ...
     *
     * @return The last known Notification IP Address
     */
     ...
     *
     * @return Opaque array of bytes representing the public key.
     */
