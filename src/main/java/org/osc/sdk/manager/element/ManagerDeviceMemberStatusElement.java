...
public interface ManagerDeviceMemberStatusElement {
    /**
     * @return the service of the device member
     */
    String getVersion();

    /**
     * @return the count of the packets received by the security function appliance
     */
    Long getRx();     // Received packets to security function appliance

    /**
     * @return the count of packets sent by the security function appliance
     */
    Long getTxSva();   // Packet sent out as instructed by security function appliance
    /**
     * @return the count of packets dropped by the security function appliance
     */
    Long getDropSva();
    ...
    /**
     * @return the gateway of the appliance
     */
     ...
     */
    String getBrokerIp(); // TODO emanoel: is this the OSC IP? is this needed?
