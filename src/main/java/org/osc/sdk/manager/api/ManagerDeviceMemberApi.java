...
public interface ManagerDeviceMemberApi {
     ...
     *
     * @param daiList  the collection of appliance instances
     * @return the status of each provided appliance instance
     */
    List<ManagerDeviceMemberStatusElement> getFullStatus(List<DistributedApplianceInstanceElement> daiList);
